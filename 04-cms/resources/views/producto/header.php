<header class="header">
    <div class="header__contenedor contenedor">
        <div class="header__contenedor__nav">
            ...
            <span class="header__contenedor__nav--separador">/</span>
            <span class="header__contenedor__nav--producto">AMD Ryzen 9 7950X3D</span>
        </div>
        <a href="index.html" class="header__contenedor__back mt-4">
            <i class="fa-solid fa-arrow-left-long"></i> Regresar a la tienda
        </a>
    </div>
</header>
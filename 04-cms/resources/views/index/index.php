...
<section class="products d-flex gap-2">
    <article class="products__item pb-2">
        ...
        <h3 class="title-n2 pl-2 pr-2 mt-1 mb-1">AMD Ryzen 5 5600X</h3>
        <p class="products__item__descri pl-2 pr-2 mb-2">
            Procesador de 6 núcleos y 12 hilos con una velocidad...
        </p>
        <div class="products__item__actions pl-2 pr-2">
            ...
            <a href="#" class="products__item__actions__btn btn btn-verde">
                <i class="fa-solid fa-bolt"></i> Agregado
            </a>
        </div>
    </article>
    <article class="products__item pb-2">
        <a class="products__item__imgBox" href="producto.html">
            <img src="img/case.webp" alt="Amd">
        </a>
        <div class="products__item__info mt-2 pl-2 pr-2">
            <span>CPU</span>
            <span>AMD</span>
        ...
        <div class="products__item__actions pl-2 pr-2">
            ...
            <a href="#" class="products__item__actions__btn btn btn-celeste">
